...
namespace POS
{
    public partial class FrmQtyOnHandUpdate : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        ...
        {
            ClsCommon.ObjQtyOnHandUpdate.Hide();
            ClsCommon.ObjQtyOnHandUpdate.Parent = null;
            e.Cancel = true;
        }
