...
namespace POS
{
    public partial class FrmSalesPriceUpdate : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        dgvItemList.Rows[j].Cells[5].Value = dt.Rows[i]["SalesPrice"].ToString();
                ...
                if (txtItemName.Text != "")
                {
                    ...
                    if (row.Length > 0)
                    {
                        ...
                        for (int i = 0; i < dtNew.Rows.Count; i++)
                        {
                            ...
                            dgvItemList.Rows[j].Cells[5].Value = dtNew.Rows[i]["SalesPrice"].ToString();
        ...
        {
            ClsCommon.ObjSalesPriceUpdate.Hide();
            ClsCommon.ObjSalesPriceUpdate.Parent = null;
            e.Cancel = true;
        }
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                dt = new BALItemMaster().SelectBySalesPrice();
                if (dt.Rows.Count > 0)
                {
